/**
 * group-path utility unit tests
 *
 * Tests for normalizeGroupPath, generateSlug, and validateGroupPath
 */

import { describe, expect, it } from 'vitest';
import { generateSlug, normalizeGroupPath, validateGroupPath } from './group-path.js';
...
describe('generateSlug', () => {
  ...
  it('should truncate generated slug to 64 chars without trailing hyphen', () => {
    expect(generateSlug('a'.repeat(100))).toBe('a'.repeat(64));
  });

  it('should not produce trailing hyphen after truncation', () => {
    // 'a-' repeated produces alternating chars; truncating at 64 could land on '-'
